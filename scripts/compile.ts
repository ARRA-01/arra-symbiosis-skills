...
async function compile() {
  console.log(`🧬 Compiling symbiosis skills to commands (v${pkg.version})...`);
...
---
*🧬 ARRA Symbiosis Skills · v${pkg.version}*
`;
  ...
  console.log(`\n✨ Compiled ${count} symbiosis skill stubs to ${COMMANDS_DIR}`);
}
